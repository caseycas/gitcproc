...
class functionObj:
    ...
    def __init__(self, name, start=0, end=0, added=0, deleted=0,exceptionDictonary={}):
        self.name = name
        self.start = start
        self.end = end
        ...
        self.excepDict= exceptionDictonary
...
class logChunk:
    ...
    def parseText(self):
        ...
        for line in self.text.split("\n"):
            ...
            if(line.startswith("+")):
                ...
                if(phase == LOOKFOREND):
                    ...
                    if(phase2==LOOKFOREXCPEND):
                        ...
                        if presentExcep!=None:
                            if str(presentExcep)+" Adds"  in exceptionDictonary.keys():
                ...
                if(phase == LOOKFOREND):
                    ...
                    if(phase2==LOOKFOREXCPEND):
                        etotal_del+=1
                        if presentExcep!=None:
                            if str(presentExcep)+ " Dels"  in exceptionDictonary.keys():
            ...
            if(phase == LOOKFORNAME):
                ...
                if(bracketDepth == nestingDepth and phase == LOOKFOREND):
                    ...
                    funcToAdd = functionObj(self.parseFunctionName(shortFunctionName), funcStart, funcEnd, ftotal_add, ftotal_del,exceptionDictonary)
                ...
                if phase2==LOOKFOREXCP:
                    ...
                    if(exceptionBlock!=None and exceptionBlock!="throw"):
                        phase2=LOOKFOREXCPEND
        ...
        self.functions = filter(lambda(x) : x.total_add != 0 or x.total_del != 0 or exceptionDictonary !={}, self.functions)
        return self
